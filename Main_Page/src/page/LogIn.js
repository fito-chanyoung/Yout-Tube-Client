...
export const Login = ({ handleLoginToggle, handleProfileUpdate }, props) => {
    ...
    return (_jsxs("div", Object.assign({ className: "container" }, { children: [_jsx("div", Object.assign({ className: "left-sector" }, { children: _jsx("img", { src: s4, className: "s4" }, void 0) }), void 0),
